...
metadata: 
  ...
  modified: 2026-08-04T09:15:40.608Z
---
...
**API 投入の罠**: `MiniMaxH3ReferenceToVideo` の autogrow 入力はフラットキー `ref_image_0` だと execute() に素通りして TypeError。**`"ref_images.ref_image_0": ["node",0]` のドット付きパスが正解**（build_nested_inputs が dict に再構成）。正本スクリプト: `/data/kita/mmh3-setup/ref2va_submit.mjs`
