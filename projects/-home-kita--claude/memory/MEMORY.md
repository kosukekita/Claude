...
- [OpenRouter動画モデルの参照画像対応](openrouter-video-models-reference-support.md) — 動画16本中refセット(人物同一性参照)対応は4本=wan-2.7(first/last/ref全部・最柔軟)/happyhorse-1.0&1.1/hailuo-2.3。first_frame(i2v)はsora以外ほぼ全部。t2v専用はsora-2-proのみ
