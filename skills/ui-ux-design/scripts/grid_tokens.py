...
# Emit UTF-8 regardless of the host console encoding. On Windows the default
# stdout codec is cp932/cp1252, which cannot encode the em dash / bullet chars
# in the generated scaffold and would crash with UnicodeEncodeError. Safe no-op
# on Linux/macOS (already UTF-8). Python 3.7+.
